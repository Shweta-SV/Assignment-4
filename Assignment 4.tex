...
\begin{figure}
   ...
   \end{axis}
   \end{tikzpicture}
   \caption{This is a plot of pair of straight lines in (1.1) taking k=-3}
   \end{figure}
...
\begin{figure}
   ...
   \addlegendentry{$-3x+1$}
   \addplot[red,thick]{(2/3)*x+2/3};
   \addlegendentry{$(2/3)x+2/3$}
   \end{axis}
   \end{tikzpicture}
   \caption{This is a plot of pair of straight lines in (1.1) taking k=-7}
   \end{figure}
   Both the plots are same. Hence the value of $k$ is verified.
\end{document} 